                                    ...
                                    <div class="main-header-one__bottom-middle">
                                        <div class="main-menu-box">
                                            ...
                                            <ul class="main-menu__list">
                                                ...
                                                @php 
                                                   $category = DB::table('category')->where('parent_id','=','0')->where('is_active','=','1')->get();
                                                @endphp
                                                <li class="dropdown">
                                                        ...
                                                        @if(isset($category) && !empty($category))
                                                            @foreach ($category as $key => $value) 
                                                                <li>
                                                                    ...
                                                                    @endif
                                                                    @php 
                                                                        $sub_category = DB::table('category')->where('parent_id','=', $value->id)->where('is_active','=','1')->get()->toArray();
                                                                    @endphp
